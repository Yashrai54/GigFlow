...
const Signin = () => {
    ...
    const handleSubmit=async()=>{
        try{
            const res= await axios.post("https://gigflow-capn.onrender.com/api/auth/signin",{email,password},{withCredentials:true})
        ...
        <div className='min-h-screen bg-linear-to-b from-sky-500 via-50% to-white flex flex-col lg:flex-row justify-around items-center p-4 lg:p-0'>
            ...
            <div className=' w-full max-w-[500px] lg:w-[500px] h-auto lg:h-[500px] bg-white mr-0 lg:mr-10 relative top-0 lg:top-1/8 rounded-md p-4 lg:p-0'>
                ...
                <div className='flex flex-col sm:flex-row items-start sm:items-center'>
                    ...
                    >
                        Sign In</button>
                    <p className='m-5 text-black font-bold text-base'>Don't Have an account?
                         <p className=' text-sky-500 cursor-pointer' onClick={()=>navigate("/signup")}>Sign Up</p></p>
                </div>

...
const Signup = () => {
    ...
    const handleSubmit = async () => {
        try {
            const res = await axios.post("https://gigflow-capn.onrender.com/api/auth/signup", { username, email, password })
    ...
    return (
        <div className='min-h-screen bg-linear-to-b from-sky-500 via-50% to-white flex flex-col lg:flex-row justify-around items-center p-4 lg:p-0'>
            ...
            >
                ...
                <p className='ml-10 text-white font-bold text-xs w-[500px]'>GigFlow is your go-to  freelancing hub.
                    Connect with  clients, showcase your skills, and get work done in your community—fast and simple.</p>
